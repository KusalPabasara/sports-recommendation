...
Stacking~\cite{caruana1997multitask} trains a meta-learner on
...
when feature spaces are heterogeneous~\cite{ma2018mmoe}.
...
Our primary model is a stacking ensemble~\cite{caruana1997multitask}
...
confirming that the ensemble approach generalises across engagement levels.
...
novelty rate (85.7\%) at the cost of lower accuracy is a feature, not a
