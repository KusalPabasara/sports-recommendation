...
Our system predicts sports preferences across playing and watching
engagement levels using classical machine learning methods---including
hyperparameter-tuned gradient boosting, random forests, and a stacking
ensemble with logistic regression as meta-learner.
...
Our stacking ensemble achieves an NDCG@5 of 0.498, representing a
\textbf{17.4\% improvement} over a physical-only XGBoost baseline (NDCG@5 = 0.424).
...
interest-first, targets general and novice users, and is equipped with a
...
\begin{IEEEkeywords}
sports recommendation, ensemble learning, interest-driven, discovery score,
personalized recommendation, physical activity, classical machine learning
\end{IEEEkeywords}
...
over the physical-only baseline (B3, NDCG@5 = 0.424) and a \textbf{16.0\%
...
Tuned XGBoost           & 0.413 & 0.676 & 0.683 \\
